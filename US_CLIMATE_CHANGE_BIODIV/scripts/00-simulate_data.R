...
simulated_spending_data$priority_threat |> min() == 1 
simulated_spending_data$priority_threat |> max() == 18 
simulated_spending_data$priority_potential |> min() == 1 
simulated_spending_data$priority_potential |> max() == 18 
simulated_spending_data$priority_rarity |> min() == 1
simulated_spending_data$priority_rarity |> max() == 18
