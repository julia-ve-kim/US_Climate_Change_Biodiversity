...
all(ifelse(is.na(cleaned_spending_data$priority_threat), TRUE, cleaned_spending_data$priority_threat %in% 1:18)) == TRUE 
all(ifelse(is.na(cleaned_spending_data$priority_potential), TRUE, cleaned_spending_data$priority_potential %in% 1:18)) == TRUE 
all(ifelse(is.na(cleaned_spending_data$priority_rarity), TRUE, cleaned_spending_data$priority_rarity %in% 1:18)) == TRUE
...
cleaned_spending_data$priority_threat |> class() == "numeric"
cleaned_spending_data$priority_potential |> class() == "numeric"
cleaned_spending_data$priority_rarity |> class() == "numeric"
